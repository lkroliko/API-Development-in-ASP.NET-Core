...
namespace CourseLibrary.API.Services
{
    public class CourseLibraryRepository : ICourseLibraryRepository, IDisposable
    {
        ...
        public IEnumerable<Author> GetAuthors(AuthorsResourceParameters parameters)
        {
            ...
            {
                collection = collection.Where(a => a.MainCategory.Contains(parameters.SearchQuery) || a.FirstName.Contains(parameters.SearchQuery) || a.LastName.Contains(parameters.SearchQuery));
            }
